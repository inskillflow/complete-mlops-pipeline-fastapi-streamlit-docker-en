...
# Chapter 01 — Step-by-step recap: Hello MLflow (the absolute basics)
...
Today (**01**) is the smallest possible MLflow program:
...
> [!NOTE]
> If you've completed chapter 05c, you already saw this exact script. Today is the formal "**chapter 1 of the recap**". Chapters 02 and 03 will add one tiny thing each.
...
services:
  mlflow:
    ...
    container_name: mlflow-recap-01
    ports:
      - "5000:5000"
    volumes:
...
Next: **[Chapter 02](./02-practical-work-mlflow-step-by-step-recap-printing-the-tracking-uri.md)** — the same script with **one new line**: `print(mlflow.get_tracking_uri())`. A tiny diff that teaches a great defensive habit.
...
<p align="center">
  <strong>End of Chapter 01 — Hello MLflow basics</strong><br/>
